        ...
        853: function (t, e, i) {
          ...
          function yt(t, e) {
            ...
            var i = e,
              ...
              j = t.elements[E ? L : _],
              T = vt(
                P(j) ? j : j.contextElement || N(t.elements.popper),
                v,
                y,
                d
              ),
              ...
              if (!e.modifiersData[d]._skip) {
                for (
                  var u = i.mainAxis,
                    ...
                    j = [O].concat(k).reduce(function (t, i) {
                      return t.concat(
                        D(i) === a
                          ? (function (t, e) {
                              void 0 === e && (e = {})
              ...
              if (k) {
                if (d) {
                  var H,
                    ...
                    nt = J(0, j[V], Z[V]),
                    ot = A
                      ? j[V] / 2 - U - nt - et - C.mainAxis
                      : X - nt - et - C.mainAxis,
                    rt = A
                      ? -j[V] / 2 + U + nt + it + C.mainAxis
                      : K + nt + it + C.mainAxis,
                ...
                (("body" !== k(e) || ut(a)) &&
                  (l =
                    (n = e) !== j(n) && T(n)
                      ...
                      : lt(n)),
                T(e)
                  ? (((d = W(e, !0)).x += e.clientLeft), (d.y += e.clientTop))
                  : a && (d.x = dt(a))),
              {
          ...
          var Ct = Tt(),
            St = Tt({ defaultModifiers: [ot, At, it, S, xt, bt, Ot, Z, Et] }),
            Dt = Tt({ defaultModifiers: [ot, At, it, S] })
        },
        902: function (t, e) {
          var i =
            (this && this.__assign) ||
